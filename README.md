## Привет, я Кирилл 👋
junior С++-разработчик имею опыт разработки консольных приложений на C++ с активным использованием STL и библиотеки Boost. Работал с системами сборки CMake, компиляторами g++ и MSVC. Настраивал автоматизации CI/CD с помощью GitHub Actions. Активно применяю
...
## 📌 Проекты
- [Document Signung Service](https://github.com/litvinov99/document-signing-service) - сервис для электронного подписания документа соглашения простой электронной подписью
- , включая генерацию PDF файла из HTML шаблона соглашения, SMS-аутентификацию, вычисления хэша методанных подписания и наложение цифрового штампа на документ.
